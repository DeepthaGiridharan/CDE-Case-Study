...
insert into MenuItems (menu_item_name, menu_item_price, menu_item_active, menu_item_dateOfLaunch, menu_item_category, menu_item_freeDelivery) values (
"Potato Wedges mini", 20.00, "Yes", "2022-08-25", "Dessert", "No");

update MenuItems set
menu_item_name="Potato Wedges",
...
insert into Users (user_first_name, user_last_name) values ("Priya","Raman");
insert into Users (user_first_name, user_last_name) values ("Ramya","Krishnan");

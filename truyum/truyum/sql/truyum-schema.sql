...
create table cart (ct_us_id INT not null, ct_pr_id INT not null,FOREIGN KEY(ct_us_id) references user(us_id),FOREIGN KEY(ct_pr_id) references menu_item(me_id),primary key(ct_us_id,ct_pr_id));

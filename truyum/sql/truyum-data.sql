...
insert into cart (ct_id,ct_us_id,ct_pr_id) values(1,2,2);
insert into cart (ct_id,ct_us_id,ct_pr_id) values(2,2,3);
insert into cart (ct_id,ct_us_id,ct_pr_id) values(3,2,5);

...
function createadminmenulist() {
    ...
    if (editedArrayString == undefined) {
        var theArrayString = JSON.stringify(adminMenuItems);
        localStorage.setItem('editedArray', theArrayString);
        var editedArrayString = localStorage.getItem("editedArray");
    }
    ...
    if (editedStr != undefined) {
        ...
        editedArray[editedObj['id']] = editedObj;
    }
    var arrayString = JSON.stringify(editedArray);
...
function addItemAdmin() {
    ...
    var active = document.getElementById("activeYes").checked ? "Yes" : "No";
...
function displayCart() {
    ...
    if (myCartString == undefined) {
        ...
        t1 = total.toFixed(2);
        document.getElementById("total").innerHTML = "Rs. " + t1;
    }
}
